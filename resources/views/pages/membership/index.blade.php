...
<section class="py-8 sm:py-16 px-4 sm:px-6">
    ...
    <div class="mb-10 sm:mb-15">
        <h3 class="text-sm sm:text-lg font-medium text-gray-800 text-center mb-4 bg-[#e2c044] py-2 px-6 rounded-2xl w-max mx-auto">
            NON-SUBSCRIPTION
        </h3>
    ...
    <div class="mb-10 sm:mb-15">
        <h3 class="text-sm sm:text-lg font-medium text-gray-800 text-center mb-4 bg-[#e2c044] py-2 px-6 rounded-2xl w-max mx-auto">ANNUAL SUBSCRIPTION</h3>
