...
@guest
<a href="{{ route('register') }}" class="text-white bg-forestgreen font-semibold rounded-xl text-sm px-6 py-3 text-center">
    Register
</a>
@endguest
...
{{-- Hero Section --}}
<section class="relative flex lg:max-h-screen">
    {{-- Container yang akan selalu terlihat di semua ukuran layar --}}
    <div class="w-full md:max-w-full mx-auto flex">

        {{-- Kolom Kiri: Gambar (45% lebar) --}}
        <div class="w-[45%] lg:w-[55%] relative lg:pb-10">
            <div id="hero-mobile" class="relative w-full h-full">
        ...
        {{-- Kolom Kanan: Teks dan Tombol (55% lebar) --}}
        <div class="w-[55%] lg:w-[45%] bg-white flex items-center justify-center px-4 py-8 rounded-r-lg">
            <div class="text-right max-w-xs">
                ...
                <div class="flex flex-col gap-3">
                    {{-- Tombol ini sekarang akan mengarah ke route 'appointment.index' --}}
