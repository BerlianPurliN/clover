<nav class="bg-deepwhite">
    <div class="max-w-full flex flex-wrap items-center justify-between px-6 py-4">
        <a href="{{ url('/') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="assets/img/logo.png" class="h-16" alt="CLOVER" />
        </a>
        <div>
            <button class="text-white bg-forestgreen font-semibold rounded-2xl text-sm px-6 py-2 text-center">REGISTER</button>
            <button id="menuToggle" type="button" class="inline-flex items-center justify-center p-2 w-10 h-10 text-black">
...
<aside id="right-sidebar"
    ...
    <div class="flex justify-end px-3 py-4 border-gray-300">
        <button id="sidebarClose" type="button" class="p-2 text-white hover:text-gray-200">
            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M1 1h15M1 7h15M1 13h15" />
            </svg>
